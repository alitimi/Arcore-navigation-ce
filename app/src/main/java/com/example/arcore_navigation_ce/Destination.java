    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                source = values;
                IntentIntegrator integrator = new IntentIntegrator(com.example.arcore_navigation_ce.Destination.this);
        ...
        nav.setOnClickListener(view -> {
            ...
            ed.commit();
            Intent intent = new Intent(com.example.arcore_navigation_ce.Destination.this, com.example.arcore_navigation_ce.BasicNavigation.class);
